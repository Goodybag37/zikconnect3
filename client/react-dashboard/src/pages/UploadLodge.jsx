...
function UploadProperty() {
  ...
  const handleSubmit = async (e) => {
        ...
        const content5 = (
          <>
            ...
            <p className="popup-paragraph">
              You need at least 300 naira in your account to upload lodge.
    ...
    try {
      ...
      const redirectPath =
        new URLSearchParams(location.search).get("redirect") || "/lodges";
      ...
      >
        ...
        <div className="input-group">
          <textarea
            ...
            placeholder="Describe your Item in few words to attract only serious customers"
            value={description}
            onClick={() => {
              setErrorMessage("");
              setError("");
